    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departmentName', models.CharField(max_length=20, unique=True, verbose_name='Department Name')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='OrderModel',
            fields=[
                ('orderNumber', models.AutoField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouseName', models.CharField(max_length=100)),
                ('sivStatus', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved')], default='Pending', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('termOfEmployment', models.CharField(choices=[('Permanent', 'Permanent'), ('Contract', 'Contract'), ('Hourly', 'Hourly')], max_length=20, verbose_name='Term of Employment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_order', to='hr.OrderModel')),
            ],
            options={
